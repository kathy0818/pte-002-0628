...
\ptesub{配图 Image}
\begin{center}\includegraphics[width=0.82\linewidth]{img/di_fog.png}\end{center}
...
\ptesub{配图 Image}
\begin{center}\includegraphics[width=0.85\linewidth]{img/di_hospital.png}\end{center}
\ptesub{范文 Model Answer}
\begin{modelbox}
...
\ptesub{配图 Image}
\begin{center}\includegraphics[width=0.97\linewidth]{img/di_majors.png}\end{center}
\ptesub{范文 Model Answer}
\begin{modelbox}
